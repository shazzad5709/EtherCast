    ...
    <div className='bg-[#f4f4f4] font-poppins h-screen flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
      <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
        ...
        <div className='w-3/5 p-5'>
          ...
          <div className='py-10'>
            <h2 className='text-3xl font-poppins mb-2 text-cyan-800'>Apply as a Voter</h2>
            ...
            <form onSubmit={onSubmit} className='flex flex-col items-center mt-2'>
              ...
              <div className='flex flex-col items-center w-64 mb-5'>
                ...
                <div className='flex gap-2'>
                  <button onClick={back} type='button' className='border-2 tracking-[2px] border-cyan-800 mb-4 mt-4 rounded-full px-14 py-2 font-semibold inline-block text-cyan-800 hover:bg-cyan-800 hover:text-white'>
                    Back
                  </button>
        ...
        <div className='w-2/5 px-12 py-36 bg-cyan-800 text-white rounded-r-2xl'>
          <h2 className='text-3xl font-poppins mb-2'>Sign in</h2>
