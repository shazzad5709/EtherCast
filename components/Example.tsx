...
const Example = (props: Props) => {
  return (
	...
	<div
        ...
        <Image src="/ec-bg-black.png" alt="heart" width={200} height={200} /> </div>
			<div className="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
				...
				<h4 className="font-black text-gray-800 md:text-xl text-xl">The Majestic and Wonderful Bahamas</h4>
