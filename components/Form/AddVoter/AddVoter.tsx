      ...
      const res = await axios
        ...
        .catch((err) =>
          setError(
            <div>
              <div
                className="bg-blue-100 border text-center border-blue-400 text-red-700 px-4 py-2 rounded relative"
                role="alert"
              >
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <div className="inline-flex space-x-4">
        <button
          type="submit"
          className="border-2 tracking-[2px] border-cyan-800 mb-2 mt-4 rounded-full px-5 py-2 font-semibold inline-block text-cyan-800 hover:bg-cyan-800 hover:text-white"
        >
          Add Voters
        </button>
      </div>
